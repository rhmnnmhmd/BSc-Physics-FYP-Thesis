...
\begin{figure}[h!]
    \centering
    \includegraphics[scale = 0.65]{Figures/default2.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale = 0.85]{Figures/compareTemporal3.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale = 0.63]{Figures/compareSpectral.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale = 0.8]{Figures/spectralTemporal1.png}
...
\begin{figure}[h!]
    \centering
     \includegraphics[scale= 0.8]{Figures/spectralTemporal2.PNG}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale = 0.8]{Figures/spectralTemporal3.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale = 0.85]{Figures/compareSpectral1.PNG}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale = 0.8]{Figures/compareSpectral2.PNG}
