...
\begin{figure}
    ...
    \caption[Plot of Forward-Scattered Intensity for 2-Level Medium]{Plot of normalized forward-scattered intensity against probe laser detuning. The green solid dots are experimental data. The black solid line is the theoretical prediction. Figure courtesy of \protect\cite{Kwong2014}.}
    \label{fig: detuned}
\end{figure}
